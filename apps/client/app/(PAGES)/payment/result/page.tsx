...
export const metadata = {
  title: "نتیجه پرداخت",
  description:
    "صفحه نتیجه پرداخت در وبسایت پکساز. در این صفحه می‌توانید نتیجه فرآیند پرداخت اشتراک خود را مشاهده کنید و اطلاعات مربوط به وضعیت پرداخت را دریافت نمایید.",
};
