...
export function initiateModel() {
  ...
  return {
    width: resolved.width.pt,
    length: resolved.length.pt,
    height: resolved.height.pt,
    widthMM: resolved.width.mm,
    lengthMM: resolved.length.mm,
    heightMM: resolved.height.mm,
